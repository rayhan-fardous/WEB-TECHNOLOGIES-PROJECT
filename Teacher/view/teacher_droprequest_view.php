...
<br>
<h3 id="academic">Student Username</h3>
...
<p3><h2 id="academic" class="myposition" style = 'position:fixed; right:436px; top:220px;'>All Drop Requests</h2></p3>
    <?php $mydata=new db();
    $connectionstring=$mydata ->OpenCon();
    $username=$_SESSION["username"];

        echo "<table id='id1' class='center' style = 'position:fixed; right:100px; top:300px;'>"; echo "<tr id='id1'><th id='id2'>Drop Id</th><th id='id2'>Student Name</th><th id='id2'>Course</th><th id='id2'>Status</th></tr>";
        
        $sql=$connectionstring->query("SELECT * FROM drop_request");

        while($row=$sql->fetch_assoc())
        {
            echo "<tr id='id1'><td id='id2'>".$row["drop_id"]."</td><td id='id2'>".$row["username"]."</td><td id='id2'>".$row["course"]."</td><td id='id2'>".$row["status"]."</td></tr>";
