...
session_start();
include "../control/admin_changeaccessteacher_control.php";
        ...
        <body>
            <form action="" method="POST">
                ...
                <table>
                    <tr>
                        <td>
                            Enter a id from the above table to block a teacher:
                        </td>
                        <td>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <?php admin_showteachers("blocked");?>
                        </td>
                    </tr>
                </table>
                <table>
                    <tr>
                        <td>
                            Enter a id from the above table to active a teacher:
                        </td>
                        <td>
